    ...
    return (
      <Pressable
        ...
        <View style={{width: wp('60%')}}>
          ...
          />
          <Lato numberOfLines={4} style={{color: 'white'}}>
            {item.overview}
          </Lato>
          <Lato style={{color: 'white', marginTop: 5, marginBottom: 10}}>
  ...
  return (
    <SafeAreaView
      ...
      <View style={{marginTop: -hp('40%'), flex: 1}}>
        <Lato style={{color: 'white', fontSize: 19, height: 40}}>
